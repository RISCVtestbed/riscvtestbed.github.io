...
| 10:20 - 10:40 | Integrating RISC-V SIMT and Scalar Cores: Loosely to Tightly Coupled ([abstract](https://riscv.epcc.ed.ac.uk/community/isc24-workshop/#integrating-risc-v-simt-and-scalar-cores-loosely-to-tightly-coupled)) ([slides](https://github.com/RISCVtestbed/riscvtestbed.github.io/blob/main/assets/files/isc24/Chetput.pdf))| Sooraj Chetput Venkataraghavan | 
