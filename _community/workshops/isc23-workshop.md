...
## Workshop details
Co-located with ISC 2023, this is a half day afternoon workshop is on Thursday 25th May 2023 in Hamburg, Germany in Hall Y8 - 2nd Floor of the Congress Center Hamburg.
...
| 14:05 - 14:40 | Keynote: Paving the Road for RISC-V Supercomputers with Open Hardware ([abstract](https://riscv.epcc.ed.ac.uk/community/isc23-workshop/#keynote-paving-the-road-for-risc-v-supercomputers-with-open-hardware)) ([slides](https://pulp-platform.org/docs/isc2023/Benini_ISC2023_paving_the_road_for_riscv.pdf))| Luca Benini |
| 14:40 - 15:00 | Evaluation of HPC Workloads Running on Open-Source RISC-V Hardware ([abstract](https://riscv.epcc.ed.ac.uk/community/isc23-workshop/#evaluation-of-hpc-workloads-running-on-open-source-risc-v-hardware))| Clay Hughes |
| 15:00 - 15:20 | Test-driving RISC-V Vector hardware for HPC ([abstract](https://riscv.epcc.ed.ac.uk/community/isc23-workshop/#test-driving-risc-v-vector-hardware-for-hpc)) ([slides](https://riscv.epcc.ed.ac.uk/assets/files/isc23/Lee1_ISC23.pdf))| Joseph Lee |
| 15:20 - 15:40 | Software Development Vehicles to enable extended and early co-design: a RISC-V and HPC case of study ([abstract](https://riscv.epcc.ed.ac.uk/community/isc23-workshop/#software-development-vehicles-to-enable-extended-and-early-co-design-a-risc-v-and-hpc-case-of-study))| Filippo Mantovani | 
| 15:40 - 16:00 | Challenges and Opportunities for RISC-V Architectures towards Genomics-based Workloads ([abstract](https://riscv.epcc.ed.ac.uk/community/isc23-workshop/#challenges-and-opportunities-for-risc-v-architectures-towards-genomics-based-workloads)) ([slides](https://riscv.epcc.ed.ac.uk/assets/files/isc23/call_isc23.pdf))| Aaron Call |
| 16:00 - 16:30 | Coffee Break | |
| 16:30 - 16:50 | Optimizations for very long and sparse vector operations on a RISC-V VPU : a work-in-progress ([abstract](https://riscv.epcc.ed.ac.uk/community/isc23-workshop/#optimizations-for-very-long-and-sparse-vector-operations-on-a-risc-v-vpu--a-work-in-progress)) ([slides](https://riscv.epcc.ed.ac.uk/assets/files/isc23/Gopinath_ISC23.pdf))| Gopinath Vasanth Mahale |
| 16:50 - 17:10 | Backporting RISC-V vector assembly ([abstract](https://riscv.epcc.ed.ac.uk/community/isc23-workshop/#backporting-risc-v-vector-assembly)) ([slides](https://riscv.epcc.ed.ac.uk/assets/files/isc23/Lee2_ISC23.pdf))| Joseph Lee |
